...
import { getDashedText } from "/home/kdog3682/2024-javascript/js-toolkit/LineEditor.js"
...
function absdir(dir) {
    ...
    return Array.from(Deno.readDirSync(expandPath(dir))).map((x) =>
        mapper(x, dir)
    )
}
function clip(s) {
